...
# Callback Handlers
async def handle_set_caption(client, callback_query):
    await add_caption(client, callback_query.message)

async def handle_delete_caption(client, callback_query):
    await delete_caption(client, callback_query.message)

async def handle_see_caption(client, callback_query):
    await see_caption(client, callback_query.message)

async def handle_view_thumbnail(client, callback_query):
    await viewthumb(client, callback_query.message)

async def handle_delete_thumbnail(client, callback_query):
    await removethumb(client, callback_query.message)
